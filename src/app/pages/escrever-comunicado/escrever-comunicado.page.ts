...
export class EscreverComunicadoPage implements OnInit {
  ...
  carregarAlunos() {
    fetch('https://creche-app.vercel.app/alunos')
      .then(res => res.json())
  ...
  async carregarDocentes() {
    try {
      const response = await fetch('https://creche-app.vercel.app/docentes');
  ...
  async salvarRascunho() {
    ...
    try {
      ...
      const response = await fetch('https://creche-app.vercel.app/rascunhos', {
        method: 'POST',
  ...
  async enviarComunicado() {
    ...
    try {
      ...
      const url = isEditing 
        ? `https://creche-app.vercel.app/comunicados/${this.comunicado.id}`
        : 'https://creche-app.vercel.app/comunicados';
